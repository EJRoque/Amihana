...
const IncomeStatementGraybar = ({ incomeStatement, setIncomeStatement }) => {
  ...
  const handlePrint = async () => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          ...
          <h2>Date: ${incomeStatement.date}</h2>
    ...
    printWindow.document.write(`
        <h3>Total Revenue: ₱${parseFloat(incomeStatement.totalRevenue.amount).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
        <h3>Total Expenses: ₱${parseFloat(incomeStatement.totalExpenses.amount).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
        <h3>Net Income: ₱${parseFloat(incomeStatement.netIncome.amount).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
      </body>
    </html>
    `);
