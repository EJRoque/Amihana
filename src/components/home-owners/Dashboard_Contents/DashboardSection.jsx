...
export default function DashboardSection({ sidebarOpen }) {
  return (
    <div className="flex flex-col grow space-y-6">
      <div className="flex w-auto desktop:flex-row laptop:flex-row justify-center space-x-6 tablet:flex-col phone:flex-col phone:space-x-0 phone:space-y-4 tablet:space-y-4 desktop:space-y-0 laptop:space-y-0">
